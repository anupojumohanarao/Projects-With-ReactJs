...
const projectsList = [
  ...
  },
  {
    ...
    title: 'Podcast Page',
    description:
      'In this assignment, lets build a Podcast Page by applying the concepts we learned till now. You can use the Bootstrap concepts and UI Kit as well.',
  },
  {
    projectId: 4,
    category: 'RESPONSIVE',
  ...
  },
  {
    ...
    description:
      'In this assignment, lets build a Portfolio Website About Me & Skills Sections by applying the concepts we learned till now.',
  },
  ...
  },
  {
    ...
    title: 'Tomato Pasta',
    description:
      'In this assignment, lets build a Recipe Page by applying the concepts we learned till now.',
  },
]
...
class App extends Component {
  ...
  render() {
    const filterProjects = this.getFilteredProjects()
    const {activeTabId} = this.state
